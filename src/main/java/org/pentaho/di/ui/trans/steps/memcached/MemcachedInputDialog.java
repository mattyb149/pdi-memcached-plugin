...
public class MemcachedInputDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  private CTabItem wFieldsTab, wDataTab;
  private Composite wFieldsComp, wDataComp;

  private TableView wFields;
  private TableView wData;

  private MemcachedInputMeta input;
  private MemcachedInputMeta memcachedInputMeta;
  private ModifyListener lsMod;

  public MemcachedInputDialog( Shell parent, Object in, TransMeta transMeta, String sname ) {
    super( parent, (BaseStepMeta) in, transMeta, sname );
    input = (MemcachedInputMeta) in;

    memcachedInputMeta = (MemcachedInputMeta) input.clone();
  }
  ...
  public String open() {
    ...
    shell.setText( BaseMessages.getString( PKG, "MemcachedInputDialog.DialogTitle" ) );
    ...
    wFieldsTab.setText( BaseMessages.getString( PKG, "MemcachedInputDialog.Meta.Label" ) );
    ...
    ColumnInfo[] colinf =
      new ColumnInfo[] {
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Name.Column" ), ColumnInfo.COLUMN_TYPE_TEXT, false ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Type.Column" ), ColumnInfo.COLUMN_TYPE_CCOMBO,
          ValueMeta.getTypes() ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Format.Column" ), ColumnInfo.COLUMN_TYPE_CCOMBO,
          Const.getDateFormats() ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Length.Column" ), ColumnInfo.COLUMN_TYPE_TEXT, false ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Precision.Column" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Currency.Column" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Decimal.Column" ), ColumnInfo.COLUMN_TYPE_TEXT, false ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Group.Column" ), ColumnInfo.COLUMN_TYPE_TEXT, false ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "MemcachedInputDialog.Value.SetEmptyString" ),
    ...
    wDataTab.setText( BaseMessages.getString( PKG, "MemcachedInputDialog.Data.Label" ) );
  ...
  private void addMemcachedInput( boolean refresh ) {

    if ( refresh ) {
      // retain changes made in the dialog...
      //
      getMetaInfo( memcachedInputMeta );
    }

    if ( refresh ) {
      // Retain the data edited in the dialog...
      //
      getDataInfo( memcachedInputMeta );
    ...
    ColumnInfo[] columns = new ColumnInfo[memcachedInputMeta.getFieldName().length];
    for ( int i = 0; i < columns.length; i++ ) {
      columns[i] = new ColumnInfo( memcachedInputMeta.getFieldName()[i], ColumnInfo.COLUMN_TYPE_TEXT, false, false );
    }
    List<List<String>> lines = memcachedInputMeta.getDataLines();
  ...
  private void getInfo( MemcachedInputMeta meta ) {
    getMetaInfo( meta );
    getDataInfo( meta );
  }

  private void getMetaInfo( MemcachedInputMeta meta ) {
  ...
  private void getDataInfo( MemcachedInputMeta meta ) {
  ...
  private void preview() {
    ...
    MemcachedInputMeta oneMeta = new MemcachedInputMeta();
    getInfo( oneMeta );
    ...
    EnterNumberDialog numberDialog =
      new EnterNumberDialog( shell, props.getDefaultPreviewSize(), BaseMessages.getString(
        PKG, "MemcachedInputDialog.EnterPreviewSize.Title" ), BaseMessages.getString(
        PKG, "MemcachedInputDialog.EnterPreviewSize.Message" ) );
