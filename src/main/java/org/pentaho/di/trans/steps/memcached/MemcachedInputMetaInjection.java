 ...
 * @author Matt
 */
public class MemcachedInputMetaInjection implements StepMetaInjectionInterface {

  private MemcachedInputMeta meta;

  public MemcachedInputMetaInjection( MemcachedInputMeta meta ) {
    this.meta = meta;
  }
  ...
  public MemcachedInputMeta getMeta() {
    return meta;
  }
